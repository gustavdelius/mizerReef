...
- [`plotSpectraPercentChange()`](https://cmbeese.github.io/mizerReef/reference/plotSpectraPercentChange.md)
  [`plotlySpectraPercentChange()`](https://cmbeese.github.io/mizerReef/reference/plotSpectraPercentChange.md)
...
- [`mizerReef-class`](https://cmbeese.github.io/mizerReef/reference/mizerReef-class.md)
  [`mizerReefSim-class`](https://cmbeese.github.io/mizerReef/reference/mizerReef-class.md)
...
These files hold example parameters and a mizerReef params object for a
simple, generic Caribbean coral reef with three functional groups.
...
Example refuge profiles for testing steady states with.
